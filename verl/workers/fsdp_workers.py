...
class ActorRolloutRefWorker(Worker):
    ...
    def _build_model_optimizer(self,
        ...
        if role == 'actor':
            ...
            num_warmup_steps1 = int(num_warmup_steps_ratio * total_steps)
            num_warmup_steps2 = optim_config.get('lr_warmup_steps', 0.)
            num_warmup_steps = max(num_warmup_steps1, num_warmup_steps2)
