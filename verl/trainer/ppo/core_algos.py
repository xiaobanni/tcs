...
def compute_policy_loss(old_log_prob, log_prob, advantages, eos_mask, cliprange, clip_higher_ratio):
    ...
    pg_losses2 = -advantages * torch.clamp(ratio, 1.0 - cliprange, 1.0 + cliprange + clip_higher_ratio)
